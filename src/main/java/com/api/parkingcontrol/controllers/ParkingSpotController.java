...
public class ParkingSpotController {
    ...
    public ParkingSpotController(ParkingSpotService parkinsSpotService) {
        this.parkingSpotService = parkinsSpotService;
    }
    ...
    public ResponseEntity<List<ParkingSpotModel>> gettAllParkingSpots(){
